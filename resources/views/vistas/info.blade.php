                ...
                <div class="card rounded-5 px-4" style="background-color:rgba(205, 205, 227, 0.8);">
                    ...
                    <div class="row">
                        <div class="col-md-3 div-superior px-4">
                            <a href="index.html"><img src="images/Preguntados-Logo.png" class="img-fluid" alt="images"></a>
                        </div>
                    </div> 
                            ...
                            <div class="col-md-5 d-flex">
                                ...
                                <div class="card rounded-5 flex-fill py-4 px-4" style="background-color: white;">
                                    ...
                                    <div class="card col-md-8 mx-auto">
                                        <div class="card-body ">
                                            <img src="images/foto_carlitos.jpeg" class="img-fluid circular--square" alt="images">
                                        </div>
                                    </div>
                                        ...
                                        <div class="card px-3 rounded-5 " style="background-color:rgb(219, 219, 219);">
                                            ...
                                            <div class="row py-2 px-5">
                                                    ...
                                                    <div class="col-md-3 mx-auto">
                                                        <a href="#"><img src="images/icono_facebook.jpg" class="img-fluid custom-image9" alt="images"></a>
                                                    </div>
                                                     <!--Creación de ícono Instagram  -->
                                                    <div class="col-md-3 mx-auto">
                                                        <a href="#"><img src="images/icono_instagram.png" class="img-fluid custom-image9" alt="images"></a>
                                                    </div>
                                                     <!--Creación de ícono Linkedin  -->
                                                    <div class="col-md-3 mx-auto">
                                                        <a href="#"><img src="images/icono_linked.png" class="img-fluid custom-image9 " alt="images"></a>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>

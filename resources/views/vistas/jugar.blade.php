...
<body style="background-image: url(images/FondoEspacio4.jpg);">
    <div class="container py-5">
        <div class="row">
                    ...
                    <div class="rounded-5" style="background-color: white;">
                        ...
                        <div class="row" >
                           ...
                           <div class="col-md-2 px-5 mt-3">
                              <img src="images/icono__mando.png" class="image-fluid custom-image9" alt="images">
                           </div> 
                           ...
                           <div class="col-md-3 g-0">
                              <img src="images/cartel.png" class="custom-image10 image-fluid" alt="image">
                           </div>
                           <!-- CREACION DE ESPACIO QUE OCUPARA LA IMAGEN de REGLAS-->
                           <div class="col-md-2 px-5">
                              <img src="images/icono_check.png" class="image-fluid custom-image9" alt="images">
                           </div>
                           ...
                           <div class="col-md-4 px-5">
                              <img src="images/icono_inidicaciones.png" class="custom-image11 py-3" alt="image">
                           </div>
                           ...
                           <div class="col-md-2 px-5">
                              <img src="images/icono_idea.png" class="image-fluid custom-image9" alt="images">
                           </div>
            ...
            <div class="col-md-5">
                <img src="images/astronauta5.jpg" class="image-fluid mx-auto mt-5 custom-image18 flotar" alt="image">
            </div>
        </div>   
    </div>

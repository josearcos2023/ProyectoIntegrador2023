            ...
            <div style="background-color:white;width: 50%;position: relative;left: 25%;"><!--PReguntas correctas-->
                <div>
                    <div style="display: flex;border: 1px solid black;padding: 10px;"><!--Caja de respuesta correcta-->
                        <div style="width: 80%">
                            <div>
                                <p style="color: black;padding-top: 10px;" class="text-center">¿A qué lenguaje de
                                    programación pertenece ese logo?</p>
                            </div>

                            <div style="display: flex;flex-direction: column;justify-content:space-evenly">
                                <!--Opciones de preguntas-->
                                <div style="display: flex;justify-content:space-around;height: 25%;">
                                    <div style="width: 30%;">
                                        <button
                                            style="width:100%;height: 70%;border-radius: 20px;background-color:lime;">
                                            <p class="">Python</p>
                                        </button>
                                    </div>
                                    <div style=" width: 30%;">
                                        <button style="width:100%;height: 70%;border-radius: 20px;">
                        ...
                        <div style="width: 20%;display: flex;justify-content: center;align-items: center;">
                            <img src="images/loog_python.png" height="100px" width="100px" alt="" class="">
                        </div>
                    </div>
